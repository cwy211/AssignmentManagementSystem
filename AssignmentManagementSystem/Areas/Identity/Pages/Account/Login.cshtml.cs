...
namespace AssignmentManagementSystem.Areas.Identity.Pages.Account
{
    ...
    public class LoginModel : PageModel
    {
        ...
        public LoginModel(SignInManager<AssignmentManagementSystemUser> signInManager, 
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    var userrole = from m in _userManager.Users
                                   where m.UserName.Equals(Input.Email)
                                   select m.userrole;
